...
def main():
    ...
    parser.add_argument("--config", required=False, default=os.path.join(os.path.dirname(__file__), "..", "config"),
                        help="Pad naar config-map met header_mapping.json en field_validation_v18.json")
    ...
    if not os.path.isfile(validation_json):
        print(f"field_validation_v18.json niet gevonden: {validation_json}", file=sys.stderr); return 2
