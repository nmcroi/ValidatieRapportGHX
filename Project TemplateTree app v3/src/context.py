...
ProductType = Literal["medisch", "lab", "facilitair", "overige"]
...
class Context:
    ...
    Attributes:
        ...
        product_types: Product categorieën (lijst)
    ...
    def get_template_basename(self) -> str:
        ...
        if self.is_staffel_file:
            ...
            return "GHXstandaardTemplate v25.1"
    ...
    def get_preset_code(self) -> str:
        ...
        # Combine multiple types or use single type
        if len(self.product_types) == 1:
            parts.append(type_codes[self.product_types[0]])
        else:
            parts.append("MIX")  # Multiple types = mixed
